...
def upload():
    ...
    if metodo == '1':
        ...
        render = render_template('index.html') 
        render = render.replace("Resultado:", 'Ranqueamento TOPSIS: ' + str(ranqTopsis) + ' Ranqueamento TOPSIS invertido: ' + str(ranqTopsisInvertido))
        return render
        ...
        if not inputTest:
            ...
            render = render_template('index.html') 
            render = render.replace("Resultado:", stringResultado)
            return render
