...
class metodo_TOPSIS:
    ...
    def TOPSIS(self): #arquivo vem aq e pesos que quiser customizar
        #MÉTODO TOPSIS
        ## QUADRO 1 - CRITÉRIOS
        #arquivo = arquivo
        ...
        quadro2Dtf = pd.DataFrame(quadro2)
        quadro2Dtf.index = range(1,len(quadro2Dtf)+1)
        ...
        ranqTopsis = ranqTopsis.to_html()
        ranqTopsisInvertido = ranqTopsisInvertido.to_html()
        #debug mostrar tabela ordenada (os prints devem ser excluídos futuramente)
        print(ranqTopsis)
        print(ranqTopsisInvertido)
        return ranqTopsis, ranqTopsisInvertido
        #legenda da planilha:
